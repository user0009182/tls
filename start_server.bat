...
openssl s_server -accept 10101 -Verify 1 -key certificates\serverkey.pem -cert certificates\servercert.pem -CAfile certificates\cacert.pem -verify_return_error